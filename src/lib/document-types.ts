...
export const DOCUMENT_TYPES = [
  { id: 'national_id', label: 'الرقم القومي', color: 'bg-blue-100 text-blue-700' },
  { id: 'birth_cert', label: 'شهادة ميلاد', color: 'bg-green-100 text-green-700' },
  { id: 'research', label: 'بحث اجتماعي', color: 'bg-purple-100 text-purple-700' },
